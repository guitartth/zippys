...
function get_vehicles_by_make($make_id, $type_id, $class_id)
{
    global $db;
    if($make_id)
    {
    ...
    {
        get_vehicles_by_type($type_id, $class_id);
    }
}

function get_vehicles_by_type($type_id, $class_id)
{
    global $db;
    if($type_id)
    {
    ...
    {
        get_vehicles_by_class($class_id);
    }
}
